...
{
    ImGuiID                 ID;
    bool                    QueryStarted;               // Query in progress
...
{
    int                     LastActiveFrame;
    ImGuiID                 QueryStackId;               // Stack id to query details for
    int                     QueryStep;
    bool                    QueryAllFinished;
    int                     QueryIdInfoFrameCount;
    ImGuiStackLevelInfo*    QueryIdInfoOutput;          // Current stack level we're hooking PushID for
